...
function ItemAttributeTypeEdit({history, selectedItemAttributeType, onEditItemAttributeType, onSaveItemAttributeType, itemTypes}) {
        ...
        <div>
            ...
            <div className="form-group">
                ...
                {/*<input className="form-control" id="itemAttrTypeDatatype" name="itemAttrTypeDatatype.itemAttrTypeDatatypeCode"
                           ...
                           onChange={onEditItemAttributeType}/>*/}
                <Dropdown name="itemAttrTypeDatatype.itemAttrTypeDatatypeCode"
                          value={selectedItemAttributeType.itemAttrTypeDatatype.itemAttrTypeDatatypeCode}
                          options={dataTypOptions} onChange={onEditItemAttributeType}/>
            </div>

            <div className="form-group">
                <label htmlFor="itemTypeIdForLookup">Lookup Item</label>
                {/*<input className="form-control" id="itemAttrTypeDatatype" name="itemAttrTypeDatatype.itemAttrTypeDatatypeCode"
                           value={selectedItemAttributeType.itemAttrTypeDatatype.itemAttrTypeDatatypeCode}
                           onChange={onEditItemAttributeType}/>*/}
                <Dropdown name="itemTypeIdForLookup"
                          value={selectedItemAttributeType.itemTypeIdForLookup}
                          options={itemTypeOptions} onChange={onEditItemAttributeType}/>
            </div>
